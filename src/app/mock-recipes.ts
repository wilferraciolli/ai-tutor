...
export const MOCK_RECIPES: RecipeModel[] = [
  {
    ...
    imgUrl: 'https://via.placeholder.com/300x200.png?text=Spaghetti+Carbonara', // Add this line
    ingredients: [
  ...
  },
  {
    ...
    imgUrl: 'https://via.placeholder.com/300x200.png?text=Caprese+Salad', // Add this line
    ingredients: [
